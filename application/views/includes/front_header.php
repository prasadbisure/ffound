...
<!--                        <li><a href="http://www.fashionfound.in/commingsoon"><span>MAKEUP & HAIR</span></a></li>-->
		...
		<div class="container">
            ...
            <a href="<?php echo site_url('vendorslisting/designer'); ?>"><button type="button" class="btn button13">DESIGNERS</button></a>
            <a href="<?php echo site_url('vendorslisting/boutique'); ?>"><button type="button" class="btn col-md-offset-1 button13">BOUTIQUES</button></a>
				...
				<!--</div>-->
				<div class="arrow bounce scroll-down" ></div>
           <!-- <button onclick="scrollWin()" class="arrow bounce" style="position:fixed;"></button>-->
