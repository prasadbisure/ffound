  ...
  <div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
                <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
                    ...
                    <div id="cd-login"> <!-- log in form -->
                        <form class="cd-form" method="post" action=<?php echo base_url(); ?>dlogin>
                            <p class="fieldset">
                            ...
                            <p class="fieldset">
                                ...
                                <input class="full-width has-padding has-border" id="signin-password" type="text"  placeholder="Password" name="password" required>
                    ...
                    <form class="cd-form" action="<?php echo base_url(); ?>packages" method="post">
                    <p class="fieldset">
                                <input class="full-width has-padding" type="submit" value="Subscribe">
                            </p>
                        </form>
